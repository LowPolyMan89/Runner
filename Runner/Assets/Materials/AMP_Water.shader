...
Shader "AMP_Water"
{
	Properties
	{
		...
		[ASEBegin]_FoamScale("FoamScale", Float) = 5
		_FoamSpeed("FoamSpeed", Float) = 1
		_FoamPower("FoamPower", Float) = 1
		_FoamColor("FoamColor", Color) = (0.5330188,0.7034079,1,0)
		[ASEEnd]_WaterColor("WaterColor", Color) = (0.1116056,0.3052817,0.7169812,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float mulTime10 = _TimeParameters.x * _FoamSpeed;
				float time8 = mulTime10;
				float2 coords8 = v.texcoord.xy * _FoamScale;
				float2 id8 = 0;
				float2 uv8 = 0;
				float voroi8 = voronoi8( coords8, time8, id8, uv8, 0 );
				float3 temp_cast_0 = (voroi8).xxx;
						 ...
						 ) : SV_Target
			{
				...
				float mulTime10 = _TimeParameters.x * _FoamSpeed;
				float time8 = mulTime10;
				float2 coords8 = IN.ase_texcoord7.xy * _FoamScale;
				float2 id8 = 0;
				float2 uv8 = 0;
				float voroi8 = voronoi8( coords8, time8, id8, uv8, 0 );
				
				float3 Albedo = ( ( pow( voroi8 , _FoamPower ) * _FoamColor ) + _WaterColor ).rgb;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float mulTime10 = _TimeParameters.x * _FoamSpeed;
				float time8 = mulTime10;
				float2 coords8 = v.ase_texcoord.xy * _FoamScale;
				float2 id8 = 0;
				float2 uv8 = 0;
				float voroi8 = voronoi8( coords8, time8, id8, uv8, 0 );
				float3 temp_cast_0 = (voroi8).xxx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float mulTime10 = _TimeParameters.x * _FoamSpeed;
				float time8 = mulTime10;
				float2 coords8 = IN.ase_texcoord2.xy * _FoamScale;
				float2 id8 = 0;
				float2 uv8 = 0;
				float voroi8 = voronoi8( coords8, time8, id8, uv8, 0 );
...
/*ASEBEGIN
Version=18900
-1452;117;1234;763;1654.247;-76.23523;1.466684;True;False
Node;AmplifyShaderEditor.RangedFloatNode;11;-1364.081,322.0629;Inherit;False;Property;_FoamSpeed;FoamSpeed;1;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;10;-1175.58,312.963;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;9;-1171.68,540.4632;Inherit;False;Property;_FoamScale;FoamScale;0;0;Create;True;0;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;8;-894.4576,221.8789;Inherit;False;0;0;1;0;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;17.81;False;2;FLOAT;1.93;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
Node;AmplifyShaderEditor.RangedFloatNode;14;-945.3589,546.1602;Inherit;False;Property;_FoamPower;FoamPower;2;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;13;-649.9363,222.7133;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1.3;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;15;-594.1474,517.2184;Inherit;False;Property;_FoamColor;FoamColor;3;0;Create;True;0;0;0;False;0;False;0.5330188,0.7034079,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;12;-319.4989,234.4629;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;16;-302.9077,598.8029;Inherit;False;Property;_WaterColor;WaterColor;4;0;Create;True;0;0;0;False;0;False;0.1116056,0.3052817,0.7169812,0;0.2019847,0.5909386,0.8396226,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;18;-506.6464,804.4569;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;17;-37.4318,374.3667;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;290.5055,566.0853;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;AMP_Water;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;Surface;1;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;0;  Use Shadow Threshold;0;Receive Shadows;0;GPU Instancing;0;LOD CrossFade;0;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;0;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;False;True;False;True;True;True;False;;False;0
...
WireConnection;1;6;18;4
WireConnection;1;8;8;0
ASEEND*/
//CHKSM=45CD2A464BD392905E71D6C6E01AA07C328861C5